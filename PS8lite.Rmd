...
```{r}
model_rf <- randomForest(form = model_formula,data = train,mtry = 5,ntree = 100)
```
...
test %>% 
  select(Id, SalePrice = SalePrice_hat_rf) %>% 
  write_csv(path = "data/submission_rf.csv")
```


![](images/submission_rf.png){ width=100% }
